...
opts.Add(BoolVariable("production", "Set defaults to build N84 for use in production", False))
...
opts.Add("vsproj_name", "Name of the Visual Studio solution", "N84")
...
if env["platform"] == "osx":
    ...
    print_warning('Platform "osx" has been renamed to "macos" in N84 4. Building for platform "macos".')
    env["platform"] = "macos"
...
if env["platform"] == "javascript":
    # Deprecated alias kept for compatibility.
    print_warning('Platform "javascript" has been renamed to "web" in N84 4. Building for platform "web".')
    env["platform"] = "web"
...
if cc_version_major == -1:
    ...
    if cc_version_major < 9:
        print_error(
            ...
            "C++17, or has bugs when compiling N84. Supported versions are 9 "
    ...
    if cc_version_major == 16 and cc_version_minor < 11:
        print_error(
            ...
            "when compiling N84. Use a newer VS2019 version, or VS2022."
        )
        Exit(255)
    if cc_version_major == 15 and cc_version_minor < 9:
        print_error(
            "Detected Visual Studio 2017 version older than 15.9, which has bugs "
            "when compiling N84. Use a newer VS2017 version, or VS2019/VS2022."
        )
        Exit(255)
    if cc_version_major < 15:
        print_error(
            "Detected Visual Studio 2015 or earlier, which is unsupported in N84. "
